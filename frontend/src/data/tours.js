  ...
  steps: [
    {
      ...
      speaker: 'aria',
      text: "Marco. Group adventure — twelve Jetzy hikers, Annapurna Base Camp, ten days. In?",
      duration: 4.626,
    ...
    },
    {
      ...
      speaker: 'marco',
      text: "I'm in. How fit do I need to be?",
      duration: 3.869,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Moderate. Pokhara to ABC — classic. Tiger Mountain Lodge to start. Welcome dinner with your group.",
      duration: 7.500,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day three — Ghorepani Poon Hill at sunrise. Dhaulagiri and Annapurna in one frame.",
      duration: 6.533,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Two doctors, a chef, a documentary filmmaker. Average age thirty-six. You'll like them.",
      duration: 6.533,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day seven — Annapurna Base Camp at dawn. Group photo at fourteen-thousand feet.",
      duration: 6.246,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day nine — back to Tiger Mountain. Massage. Lake Phewa sunset paddle.",
      duration: 6.246,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Ten days. Twelve new friends. Thirty-eight hundred all in. Booked?",
      duration: 4.104,
  ...
  steps: [
    {
      ...
      speaker: 'aria',
      text: "School half-term. You, Sofia, the kids — never been to Iceland. Five days?",
      duration: 4.99,
    ...
    },
    {
      ...
      speaker: 'marco',
      text: "Make it magical. Kids first. Geysers, whales, glaciers.",
      duration: 4.94,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Ion Adventure Hotel near Thingvellir. Two nights. Northern lights from the glass-roof bar after the kids are asleep.",
      duration: 6.90,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day two — the Golden Circle. Strokkur geyser. Gullfoss waterfall. Lunch at Friðheimar tomato farm.",
      duration: 7.21,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day three — fly to Akureyri. Húsavík whale watching. Humpbacks ninety percent of the time in May.",
      duration: 6.85,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day four — glacier walk on Sólheimajökull. Kids in mini crampons with a guide. Thermal pool after.",
      duration: 6.66,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day five — Hallgrímskirkja in Reykjavík. Skyr and pastries at Brauð and Co before the flight.",
      duration: 6.61,
  ...
  steps: [
    {
      ...
      speaker: 'aria',
      text: "Sofia and the girls. Long weekend. Where to?",
      duration: 3.37,
      camera: { lng: -7.99, lat: 31.63, height: 2_500_000, pitch: -0.95, duration: 2.8 },
    },
    {
      audio: '/demo-audio-ma/02-marco-pick.mp3',
      speaker: 'marco',
      text: "Somewhere we can fully reset. Spa, food, photos.",
      duration: 4.44,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Marrakech. La Mamounia, three nights. Mamounia Suite with garden access.",
      duration: 6.56,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day two — hammam at Royal Mansour. Lunch on the rooftop at Nomad. Le Jardin Secret in the afternoon.",
      duration: 6.98,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Day three — sunrise hot-air balloon over the Atlas. Lunch at Fellah Hotel. Sky Bar Renaissance for cocktails.",
      duration: 7.40,
    ...
    {
      audio: '/demo-audio-ma/06-marco-souks.mp3',
      speaker: 'marco',
      text: "Souks?",
      duration: 0.86,
    ...
    },
    {
      ...
      speaker: 'aria',
      text: "Last day. Mahmood Mahjoub guide. Argan oil, lanterns, leather. He keeps the touts off you.",
      duration: 5.91,
    ...
    {
      audio: '/demo-audio-ma/09-marco-yes.mp3',
      speaker: 'marco',
      text: "Booked.",
      duration: 0.81,
